...
def load_flags(mode = 'train'):
    ...
    if mode == 'train':
        flags.DEFINE_string('source-file-1', None, 'Path of transcription file 1')
        flags.DEFINE_string('source-file-2', None, 'Path of transcription file 2')
        flags.DEFINE_string('source-file-3', None, 'Path of transcription file 3')
        flags.DEFINE_string('source-file-4', None, 'Path of transcription file 4')
        flags.DEFINE_string('dann-file', None, "Path of file containing target samples")
    if mode == 'infer':
